...
export default function Candidato(props) {
    const [curtida,setCurtida]=useState(props.candidato.curtidas)
    const [descurtida,setDescurtida]=useState(props.candidato.descurtidas)
    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button onClick={()=>{
                                    setCurtida(++props.candidato.curtidas)    
                ...
                </Button> <Button onClick={()=>{setDescurtida(++props.candidato.descurtida)
                ...
                <Button onClick={()=>{ props.detalhesDoCandidato(props.candidato) }} className="mt-1" variant="success">Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}